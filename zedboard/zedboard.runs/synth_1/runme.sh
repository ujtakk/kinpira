...
HD_PWD='/ram/home/work/takau/kinpira/zedboard/zedboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kinpira_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source kinpira_wrapper.tcl
